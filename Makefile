...
generate: bin/mga ## Generate code
	mga generate kit endpoint ./internal/app/order/...
	mga generate event handler --output subpkg:suffix=gen ./internal/app/order/...
	mga generate event dispatcher --output subpkg:suffix=gen ./internal/app/order/...
